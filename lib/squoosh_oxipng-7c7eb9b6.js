  ...
  try {
    await Promise.all(
      Array.from({ length: builder.numThreads() }, () => {
        ...
        const worker = new Worker(new URL(new URL('assets/workerHelpers-3956c5b4.js', import.meta.url).href, import.meta.url), {
          type: 'module'
        });
...
async function init(input, maybe_memory) {
    if (typeof input === 'undefined') {
        input = new URL(new URL('assets/squoosh_oxipng_bg-89ef9006.wasm', import.meta.url).href, import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
